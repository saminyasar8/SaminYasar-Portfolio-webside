        ...
        <div class="container">
            ...
            <div class="row g-4 portfolio-grid">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="graphic">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQydXrXW8vUPSgtd7AAGaRDN94vku7eNFna3Q&s" class="card-img-top" alt="Brand Identity">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="app">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="https://i.pinimg.com/736x/e1/d2/8d/e1d28d807962765a81a2a12e476ae2d5.jpg" class="card-img-top" alt="Travel App">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item" data-category="web">
                    <div class="card border-0 shadow-sm overflow-hidden">
                        <div class="portfolio-img-wrapper">
                            <img src="https://i.ytimg.com/vi/L9yYvld0940/sddefault.jpg"
                            class="card-img-top" alt="Restaurant Website">
                            <div class="portfolio-overlay">
                                <div class="overlay-content">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="images/project1.jpg" class="img-fluid mb-4" alt="E-commerce Website">
